...
class _SetupPageState extends State<SetupPage> {
  ...
  Future init() async {
    _fetchSkipSetup();
    final bool fastLoginPreference =
        await UserPreferences.getPrefersFastLogin();
      ...
      appBar: skipSetup
          ? AppBar(
              ...
              leading: IconButton(
                ...
                onPressed: () {
                  TercihiKaydetveDevamEt();
                  BilgileriKaydetveDevamEt();
                  KurulumuTamamla();
                },
              ),
            )
        ...
        child: Stepper(
                    ...
                    OutlinedButton(
                        style: OutlinedButton.styleFrom(
                            side: const BorderSide(
                                width: 2, color: Color(0xFFBAC3FF))),
                        onPressed: () {
                          setState(() {
                            currentStep--;
                          });
            ...
            steps: [
                      ...
                      ListTile(
                        ...
                        subtitle: RichText(
                            text: TextSpan(
                              ...
                              const TextSpan(
                                  text:
                                      'e-Devlet ile giriş yaparken iki aşamalı kimlik doğrulama kullanmıyorsan\n'),
                              TextSpan(
                                  text: "e-Devlet bilgileriyle giriş",
                                  style: const TextStyle(
                              ...
                              RotatedBox(
                                ...
                                child: Switch(
                                    ...
                                    inactiveThumbImage: const AssetImage(
                                        "assets/images/logo_rotated.png"),
                                    activeThumbImage: const AssetImage(
                                        "assets/images/edevletk_logo_rotated.png"),
              ...
              Step(
                ...
                title: Text(prefersFastLogin
                    ? "e-Devlet Giriş Bilgilerin"
                    : "OBS Giriş Bilgilerin"),
                content: prefersFastLogin
                    ? Form(
                        key: eDevletFormKey,
                        child: Column(
                          children: [
